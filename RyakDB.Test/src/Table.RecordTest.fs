...
module RecordFileTest =
    ...
    let ``record file`` () =
        ...
        let rf1 = RecordFile.newRecordFile db.FileMgr tx true ti
        ...
        let rf2 = RecordFile.newRecordFile db.FileMgr tx true ti
        ...
        let rf3 = RecordFile.newRecordFile db.FileMgr tx true ti
        ...
        let rf4 = RecordFile.newRecordFile db.FileMgr tx true ti
