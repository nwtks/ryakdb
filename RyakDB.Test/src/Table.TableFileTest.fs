...
let ``record file`` () =
    ...
    let rf1 = newTableFile db.FileMgr tx true ti
    ...
    let rf2 = newTableFile db.FileMgr tx true ti
    ...
    let rf3 = newTableFile db.FileMgr tx true ti
    ...
    let rf4 = newTableFile db.FileMgr tx true ti
